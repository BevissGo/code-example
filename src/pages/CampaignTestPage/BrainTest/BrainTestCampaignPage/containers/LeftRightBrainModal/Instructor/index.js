...
const LeftRightBrainModalInstructor = ({ onStartSurvey, contentContainer, amountPageSurvey, loading }) => {
  return (
    <div className='lr-brain-modal-instructor'>
      <div className='lr-brain-modal-instructor__modal'>
        <ScrollAnimation offset={0} animateIn='animate__fadeIn' duration={0.75} animateOnce={true}>
          <p className='lr-brain-modal-instructor__header'>{contentContainer.title}</p>
        </ScrollAnimation>
        <ScrollAnimation offset={0} animateIn='animate__fadeIn' duration={0.75} animateOnce={true}>
        ...
        <div className='lr-brain-modal-instructor__footer'>
          <ScrollAnimation offset={0} animateIn='animate__fadeIn' duration={0.75} animateOnce={true}>
            <Button
              ...
              isDisabled={loading || amountPageSurvey === 0}
