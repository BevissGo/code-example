...
const ResultBasic = ({ handleShowShareModal }) => {
  ...
  return (
    ...
    >
      <div
        className='result-basic__overview'
        style={{
          paddingBottom: profile?.shared_facebook ? 0 : '30px',
        }}
      >
        <p className='result-basic__overview__title'>{title}</p>

        <div
          className='result-basic__overview__body'
          style={{
        ...
        {!profile?.shared_facebook && (
          <div className='result-basic__overview__summary'>
