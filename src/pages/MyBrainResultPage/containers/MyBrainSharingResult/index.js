...
const MyBrainSharingResult = ({ infoUser, contentContainer }) => {
  const urlSharingResult = `${config.URIClient}/result/${infoUser._id || ''}`
  const dispatch = useDispatch()

  return (
    <div className='my-brain-sharing-result'>
      <div className='my-brain-sharing-result__background'>
        <ScrollAnimation offset={0} animateIn='animate__fadeIn' duration={0.75} animateOnce={true}>
          <p className='my-brain-sharing-result__title'>{contentContainer.title}</p>
        </ScrollAnimation>
        <div className='my-brain-sharing-result--copy-link'>
          <ScrollAnimation offset={0} animateIn='animate__fadeIn' duration={0.75} animateOnce={true}>
            <div className='my-brain-sharing-result--copy-link__container'>
        ...
        <div className='my-brain-sharing-result__or'>
          <ScrollAnimation offset={0} animateIn='animate__fadeIn' duration={0.75} animateOnce={true}>
            <span>Hoặc</span>
          </ScrollAnimation>
          <div className='line'></div>
        </div>
        <div className='my-brain-sharing-result--social'>
          <FacebookShareButton
...
export default MyBrainSharingResult
